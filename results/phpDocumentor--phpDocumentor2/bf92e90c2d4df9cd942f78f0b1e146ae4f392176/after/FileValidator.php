...
class FileValidator extends ClassValidator
{
    ...
    public function isValid()
    {
        ...
        if (!$this->docblock) {
            $this->logParserError('ERROR', 'PPC:ERR-50007', $this->lineNumber, array($filename));
            return false;
        }
        ...
        if ('' === $this->docblock->getShortDescription()) {
            $this->logParserError('CRITICAL', 'PPC:ERR-50008', $this->lineNumber, array($this->entityName));
            $valid = false;
        }
