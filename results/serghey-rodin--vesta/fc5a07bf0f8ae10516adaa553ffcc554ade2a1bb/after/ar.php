...
$LANG['ar'] = array(
    ...
    'Buy Licence' => 'اشتري ترخيص',
    'Buy Lifetime License' => 'اشتري ترخيص مدى الحياة',
    'Disable and Cancel Licence' => 'إلغاء وتعطيل الترخيص',
    'Licence Activated' => 'الترخيص مفعل',
    'Licence Deactivated' => 'الترخيص معطل',
    'Restrict users so that they cannot use SSH and access only their home directory.' => 'قيد المستخدمين بحيث لايستطيعون استخدام SSH ويستطيعون الدخول فقط إلى المجلد الرئيسي الخاص بهم فقط.',
    'Browse, copy, edit, view, and retrieve all of your web domain files using fully featured File Manager.' => 'استعراض, نسخ, تحرير, فتح, واستعادة كل ملفات موقعك باستخدام مدير ملفات مكتمل الوظائف.',
    'This is a commercial module, you would need to purchace license key to enable it.' => 'هذه الخدمة تجارية ومأجورة, تحتاج لشراء مفتاح ترخيص لتمكينها.'
