...
$string['enrolname'] = 'Egyszerû állomány';
$string['filelockedmail'] = 'AZ Ön által beíratkozásra használt szöveges állományt ($a) a cron folyamattal nem lehet törölni. Ez olyankor fordul elõ, ha nem megfelelõ engedélyek vannak hozzárendelve. Állítsa be az engedélyeket úgy, hogy a Moodle törölni tudja az állományt, ellenkezõ esetben feldolgozása megismétlõdhet.';
