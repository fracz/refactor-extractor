...
<p>Az LDAP-beíratkozás használatához felhasználóinak érvényes azonosítószámot tartalmazó mezõkkel <strong>kell</strong>
...
$string['enrol_ldap_autocreate'] = 'Automatikusan létrehozhatók kurzusok, ha a Moodle-ban még nem létezõ kurzusra íratkoznak fel.';
...
$string['enrol_ldap_student_memberattribute'] = 'Tag jellemzõje, ha a felhasználó egy csoporthoz tartozik (íratkozott be). Általában \'tag\'
vagy \'tagazonosító\'.';
...
\'ou=kurzusok,o=org; ou=egyebek,o=org\'';
$string['enrol_ldap_teacher_memberattribute'] = 'Tag jellemzõje, ha a felhasználó egy csoporthoz tartozik (íratkozott be). Általában \'tag\'
vagy \'tagazonosító\'.';
