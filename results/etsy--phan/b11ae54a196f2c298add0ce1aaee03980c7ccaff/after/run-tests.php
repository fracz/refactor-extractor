...
/* $Id: 70d9cc3f5daf39b291a3b57ecfa4201a50ac36ab $ */
...
putenv("TEST_PHP_EXECUTABLE=./phan");
		...
		while ($repeat) {
			...
			switch($switch) {
				...
				case '--html':
					...
					break;
				case '--version':
					echo '$Id: 70d9cc3f5daf39b291a3b57ecfa4201a50ac36ab $' . "\n";
					exit(1);
...
function system_with_timeout($commandline, $env = null, string $stdin = null)
{
...
";
	...
	if (array_key_exists('POST_RAW', $section_text) && !empty($section_text['POST_RAW'])) {
		...
		$cmd = "$php -m short \"$test_file\" $args 2>&1";
	}
...
{
	global $n_total, $sum_results, $percent_results, $end_time, $start_time, $failed_test_summary, $PHP_FAILED_TESTS, $leak_check;
