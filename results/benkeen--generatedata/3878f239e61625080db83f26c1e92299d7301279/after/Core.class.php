...
class Core {
	...
	// overridable settings that the user may define in settings.php
 	...
 	/**
 	 * The database hostname - usually, this is automatically generated by the installation script and <b>must</b> be set in the
 	 * settings.php file in order for the script to function.
     * @access private
     * @static
     * @var string
     * @see Core::getHostname()
     */
	private static $dbHostname;

 	/**
 	 * The database name - usually generated by the installation script and <b>must</b> be set in the settings.php file in
	...
	private static $dbName;
 	...
 	/**
 	 * The database username - usually generated by the installation script and <b>must</b> be set in the settings.php file in
 	 * order for the script to function.
     * @access private
     * @static
     * @var string
     * @see Core::getDbUsername()
     */
	private static $dbUsername;

 	/**
 	 * The database password - usually generated by the installation script and <b>must</b> be set in the settings.php file in
 	 * order for the script to function.
     * @access private
     * @static
     * @var string
     * @see Core::getDbPassword()
     */
     ...
     * @static
     * @var string
     * @see Core::getDbTablePrefix()
     */
	private static $dbTablePrefix = "gd_";

 	/**
 	 * Passwords are encrypted using a encryption salt - this variable is usually generated by the installation script and
 	 * <b>must</b> be set in the settings.php file.
     * @access private
     * @static
     * @var string
     * @see Core::getEncryptionSalt()
     */
