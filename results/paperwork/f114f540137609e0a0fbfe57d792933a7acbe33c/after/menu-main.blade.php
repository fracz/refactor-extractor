<ul class="nav navbar-nav animate-panel" ng-cloak ng-show="navbarMainMenu">
	...
	<li class="dropdown">
		...
		<ul class="dropdown-menu" role="menu">
			...
			<li ng-controller="SidebarNotesController" class="{{ menuItemNoteClass('multiple') }}">
				<a id="menu-item-edit-sub-share_note" href="" ng-click="modalShareNote(getNotebookSelectedId(), (getNoteSelectedId(true)).noteId)"><i class="fa fa-share-o"></i> <span ng-hide="editMultipleNotes">[[Lang::get('keywords.share_note')]]</span><span ng-show="editMultipleNotes">[[Lang::get('keywords.share_notes')]]</span></a>
			</li>
			<li class="divider"></li>
