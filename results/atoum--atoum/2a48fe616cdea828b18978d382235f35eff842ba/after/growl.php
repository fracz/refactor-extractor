	...
	public function testNotify()
	{
		$this
			...
			->then
				...
				->mock($field)
					->call('execute')->withArguments('growlnotify --title %s --name atoum --message %s --image %s', array('Success !', $successString, realpath(__DIR__ . '/../../../../../../../../resources/images/logo_success.png')))->once()
			...
			->then
				...
				->mock($field)
					->call('execute')->withArguments('growlnotify --title %s --name atoum --message %s --image %s', array('Failure !', $failureString, realpath(__DIR__ . '/../../../../../../../../resources/images/logo_fail.png')))->once()
