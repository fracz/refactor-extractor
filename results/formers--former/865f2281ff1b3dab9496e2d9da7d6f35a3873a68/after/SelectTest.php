...
class SelectTest extends FormerTests
{
  ...
  public function testMultiselect()
  {
    ...
    $matcher = $this->controlGroup('<select multiple="true" id="foo" name="foo"></select>');
  ...
  {
    $this->former->select('foo')->options($this->options);

    $this->assertEquals($this->former->field()->getOptions(), $this->options);
  }
