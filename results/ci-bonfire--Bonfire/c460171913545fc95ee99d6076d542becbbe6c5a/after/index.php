	...
	<div id="header">
		...
		<div id="toolbar">
			<div id="toolbar-right">
				<a href="<?php echo site_url('admin/settings/users/edit/'. $this->auth->user_id()) ?>" id="tb_email"></p><?php echo config_item('auth.login_type') == 'username' ? $user->auth->username() : $this->auth->email() ?></a>
