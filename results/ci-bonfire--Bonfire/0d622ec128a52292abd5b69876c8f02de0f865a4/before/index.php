	...
	<div id="header">
		...
		<div id="toolbar">
			<div id="toolbar-right">
				<a href="<?php echo site_url('admin/settings/users/edit/'. $this->auth->user_id()) ?>" id="tb_email" title="<?php echo lang('bf_user_settings') ?>"><?php echo config_item('auth.use_usernames') ? $this->auth->username() : $this->auth->identity() ?></a>
