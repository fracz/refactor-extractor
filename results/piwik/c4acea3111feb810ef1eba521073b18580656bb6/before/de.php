...
$translations = array(
	...
	'General_TranslatorName' => 'Frank Bueltge, Thorsten Taube, Arthur W. Borens, Marco Ziesing, Andreas Just, Fabian Becker, Henry Müller, Pascal Herbert, Christian W. Schneider, Michael Stenz',
	'General_TranslatorEmail' => 'frank@bueltge.de, piwik@thorstentaube.de, arthur.borens@gmx.de, mail@marco-ziesing.de, andreas.just@cmsmadesimple.de, halfdan@xnorfz.de, ich@pascal90.de, christian@conlabz.de, michael.stenz@email.de',
	...
	'General_VisitTypeExample' => 'Um zum Beispiel alle wiederkehrenden Besucher zu selektieren, welche in der Vergangenheit Bestellungen generiert haben, die API Abfrage enthält %s',
	...
	'General_EcommerceVisitStatus' => 'Besucher Ecommerce Status am ende des Besuchs. Um z.B. alle Besucher, welche eine Ecommerce Bestellung getätigt haben zu selektieren, muss er API Aufruf folgendes enthalten %s',
	...
	'General_ColumnNbUniqVisitorsDocumentation' => 'Die Anzahl der einzigartigen Besucher auf der Webseite. Jeder Benutzer wird nur einmal gezählt, auch wenn er die Webseite mehrmals täglich besucht hat.',
	'General_ColumnNbVisits' => 'Besuche',
	'General_ColumnNbVisitsDocumentation' => 'Falls ein Besucher zum ersten mal die Webseite besucht oder ein Besuch mehr als 30 Minuten seit dem letzten Aufruf her ist, wird dies als neuer Besuch gewertet.',
	'General_ColumnPercentageVisits' => '% Besuche',
	'General_ColumnNbActions' => 'Aktionen',
	'General_ColumnNbActionsDocumentation' => 'Die Anzahl der Aktionen, welcher ein Besucher durchgeführt hat. Aktionen sind die Ansicht von Seiten, Downloads und der Aufruf von externen Links.',
	...
	'General_ColumnExitRateDocumentation' => 'Die Prozentzahl der Besuche welche die Webseite nach dieser Seite verlassen haben.',
	...
	'General_ColumnUniquePageviewsDocumentation' => 'Die Anzahl der Besuche, welche diese Seite betrachtet haben. Sollte die Seite mehrmals bei einem Besuch betrachtet worden sein, so wird dies nur einmal gezählt.',
	...
	'CoreAdminHome_CustomLogoFeedbackInfo' => 'Sollte das Piwik-Logo anpassen, so ist sicher auch das verstecken des %s-Links in der Navigation von Interesse. Bitte dazu das Feedback Plugin auf der %sManage Plugins%s Seite deaktivieren',
	...
	'PrivacyManager_AnonymizeIpDescription' => 'Wähle "Ja", wenn Piwik nicht die komplette IP-Adresse speichern soll.',
	'PrivacyManager_AnonymizeIpMaskLengtDescription' => 'Wähle aus wieviele Bytes der Busucher IP maskiert werden soll.',
	...
	'CoreHome_NoPrivilegesAskPiwikAdmin' => 'Du bist eingeloggt als \'%s\', aber es wurden keine Berechtigungen für den Benutzer in Piwik gesetzt. %s Bitte unterrichte einen Piwik Administrator (klicken für E-Mail)%s um "Lesen"-Berechtigung für die Webseite zu erhalten.',
	...
	'Goals_LeftInCart' => '%s wurde im Warenkorb',
	...
	'Goals_ColumnRevenueDocumentation' => 'Komplette Ertragssumme generiert von %s.',
	'Goals_ColumnConversionRateDocumentation' => 'Prozentzahl der Besuche, welche das Ziel %s ausgeführt haben.',
	'Goals_ColumnRevenuePerVisitDocumentation' => 'Der Gesamtertrag generiert bei %s geteilt durch die Anzahl der Besuche.',
	...
	'Goals_GoalConversions' => 'Ziel Erfüllungen',
	...
	'Mobile_AnonymousTracking' => 'Anomymes aufzeichnen',
	...
	'Referers_SearchEnginesDocumentation' => 'Ein Besucher kam durch eine Suchmaschine auf deine Webseite. %s Den %s Report einsehen für mehr Details.',
	'Referers_WebsitesDocumentation' => 'Des Besucher folgte einem Link auf einer anderen Webseite um hierher zu gelangen. %s Im %s Bereicht gibt es weitere Details.',
	...
	'UsersManager_ChangePasswordConfirm' => 'Das ändern des Kennworts ändert ebens die token_auth des Benutzers. Wirklich fortfahren?',
