...
$translations = array(
	...
	'SitesManager_SuperUserCanExcludeIpsOnAllWebsites' => 'The Super User can also %1sexclude IPs from being tracked on all websites%2s',
    'SitesManager_ExcludedIps' => 'Excluded IPs',
    'SitesManager_ListOfIpsToBeExcludedOnAllWebsites' => 'You can enter below the list of IPs to be excluded from being tracked on all websites.',
	'SitesManager_GlobalListExcludedIps' => 'Global list of Excluded IPs',
	'SitesManager_HelpExcludedIps' => 'Enter the list of IPs, one per line, that you wish to exclude from being tracked by Piwik. You can use wildcards, eg. %1s or %2s ',
