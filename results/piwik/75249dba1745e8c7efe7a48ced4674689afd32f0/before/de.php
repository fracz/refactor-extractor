...
$translations = array(
	...
	'General_TranslatorName' => 'Frank Bueltge, Thorsten Taube, Arthur W. Borens, Marco Ziesing, Andreas Just, Fabian Becker, Henry Müller, Pascal Herbert, Christian W. Schneider, Michael Stenz, <a href="http://www.itransition.com/">Itransition</a>',
	'General_TranslatorEmail' => 'frank@bueltge.de, piwik@thorstentaube.de, arthur.borens@gmx.de, mail@marco-ziesing.de, andreas.just@cmsmadesimple.de, halfdan@xnorfz.de, ich@pascal90.de, christian@conlabz.de, michael.stenz@email.de, djsoldier1988@gmail.com',
	...
	'General_VisitConvertedGoalId' => 'Besuchen Sie konvertiert ein bestimmtes Ziel Id',
	...
	'General_ParameterMustIntegerBetween' => 'Parameter %s muss ein ganzzahliger Wert zwischen sein %s und %s.',
	...
	'General_ColumnBounceRateDocumentation' => 'Der Prozentsatz der Besuche, hatte nur einen einzigen Seitenaufruf. Dies bedeutet, dass der Besucher der Website direkt links vom Eingang zu sehen.',
	'General_ColumnBounceRateForPageDocumentation' => 'Prozentsatz der Besuche die auf dieser Seite starteten und zugleich endeten.',
	'General_ColumnPageBounceRateDocumentation' => 'Der Anteil der Besuche auf dieser Seite gestartet und verließ die Website sofort.',
	...
	'General_BrokenDownReportDocumentation' => 'Er ist in verschiedenen Berichten, die in Sparklines am unteren Rand der Seite angezeigt werden gebrochen. Sie können die Grafiken, indem Sie auf den Bericht, den Sie gerne sehen würden zu vergrößern.',
	'General_ChangeTagCloudView' => 'Bitte beachten Sie, dass Sie den Bericht in anderer Weise als wie eine Tag-Cloud anzuzeigen. Verwenden Sie die Steuerelemente am unteren Ende des Berichts zu tun.',
	...
	'CoreHome_ExcludeLowPopulation_js' => 'Niedrige Werte ausschließen',
	...
	'Goals_DocumentationRevenueGeneratedByProductSales' => 'Umsatz ohne Steuer, Versand und Rabatt',
	...
	'Live_VisitorsLastVisit' => 'Der letzte Besuch deises Besuchers war vor %s Tagen.',
	...
	'Referers_SearchEnginesDocumentation' => 'Ein Besucher kam durch eine Suchmaschine auf deine Webseite. %s Nutze den %s Bericht für weitere Details.',
	'Referers_WebsitesDocumentation' => 'Des Besucher folgte einem Link auf einer anderen Webseite, um auf deine Seite zu gelangen. %s Im %s Bereicht gibt es weitere Details.',
