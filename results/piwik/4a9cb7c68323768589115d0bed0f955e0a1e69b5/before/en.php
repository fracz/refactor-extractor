...
$translations = array(
	...
	'CoreAdminHome_OptOutExplanationBis' => 'The tag will display an Iframe containing a link for your visitors to opt-out of Piwik by setting an opt-out cookie in their browsers. %s Click here%s to view the content that will be displayed by the iFrame.',
	...
	'UserCountry_country_ly' => 'Libyan Arab Jamahiriya',
	...
	'UsersManager_ExceptionInvalidLoginFormat' => 'The login must be between %1$s and %2$s characters long and contain only letters, numbers, or the characters \'_\' or \'-\' or \'.\' or \'@\'',
	...
	'PDFReports_CreateAndSchedulePDFReport' => 'Create and Schedule a PDF report',
	'PDFReports_CancelAndReturnToPDF' => 'Cancel and %sreturn to the list of PDF Reports%s',
	'PDFReports_DescriptionWillBeFirstPage' => 'The report description will be displayed on the first page of the PDF report.',
	'PDFReports_WeeklyScheduleHelp' => 'Weekly schedule: report will be sent the first Monday of each week.',
	...
	'PDFReports_ReportsIncludedInPDF' => 'Reports included in PDF',
	'PDFReports_CreatePDFReport' => 'Create PDF Report',
	'PDFReports_UpdatePDFReport' => 'Update PDF Report',
