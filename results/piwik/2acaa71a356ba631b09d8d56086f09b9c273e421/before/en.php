...
$translations = array(
	...
	'General_ExceptionFilesizeMismatch' => 'File size mismatch: %s (expected length: %s, found: %s)',
	'General_ExceptionFileIntegrity' => 'Integrity check failed: %s (expected md5sum: %s)',
...
Note that it is not necessary to specify the URLs with and without \'www\' as Piwik automatically considers both.',
	...
	'Installation_SystemCheckMbstringHelp' => 'Missing mb_substr_replace() function. You should set mbstring.func_overload to "0".',
	'Installation_SystemCheckFileIntegrity' => 'File integrity',
	'Installation_SystemCheckFileIntegrityHelp' => 'File integrity check could not be completed due to missing config/manifest.inc.php or md5_file() function.',
