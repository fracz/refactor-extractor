...
$strMIME_transformation_options_note = 'Zadejte parametry transformací v&nbsp;následujícím tvaru: \'a\',\'b\',\'c\'...<br />Pokud potřebujete použít zpětné lomítko (&dbquo;\&ldquo;) nebo jednoduché uvozovky (&dbquo;\'&ldquo;) mezi těmito hodnotami, vložte před ně zpětné lomítko (například \'\\\\xyz\' nebo \'a\\\'b\').';
...
$strNoFrames = 'phpMyAdmin se lépe používá v&nbsp;prohlížeči podporujícím rámy (&dbquo;FRAME&ldquo;).';
...
$strPrimaryKeyWarning = '(&dbquo;PRIMARY&ldquo; <b>musí</b> být jméno <b>pouze</b> primárního klíče!)';
$strPrimary = 'Primární';
...
$strSetEnumVal = 'Pokud je sloupec typu &bdquo;enum&ldquo; nebo &bdquo;set", zadávejte hodnoty v&nbsp;následujícím formátu: \'a\',\'b\',\'c\'...<br />Pokud potřebujete zadat zpětné lomítko (&dbquo;\&ldquo;) nebo jednoduché uvozovky (&dbquo;\'&ldquo;) mezi těmito hodnotami, napište před ně zpětné lomítko (příklad: \'\\\\xyz\' nebo \'a\\\'b\').';
