...
$strNoIndex = 'Sloupec nemá definovaný ¾ádný index!';
...
$strPrimaryKeyWarning = '(&dbquo;PRIMARY&ldquo; <b>musí</b> být jméno <b>pouze</b> primárního klíèe!)';
$strPrimary = 'Primární';
...
$strSetEnumVal = 'Pokud je sloupec typu &bdquo;enum&ldquo; nebo &bdquo;set", zadávejte hodnoty v&nbsp;následujícím formátu: \'a\',\'b\',\'c\'...<br />Pokud potøebujete zadat zpìtné lomítko (&dbquo;\&ldquo;) nebo jednoduché uvozovky (&dbquo;\'&ldquo;) mezi tìmito hodnotami, napi¹te pøed nì zpìtné lomítko (pøíklad: \'\\\\xyz\' nebo \'a\\\'b\').';
