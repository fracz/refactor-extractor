...
$strImportLargeFileUploading = 'O ficheiro que se vai enviar é, posibelmente, maior do que o tamaño máximo permitido ou este é un erro coñecido no dos navegadores baseados en webkit (Safari, Google Chrome, Arora etc.).';
$strImportProceedingFile = 'Estase a procesar o ficheiro; teña paciencia, por favor.';
$strImportUploadInfoNotAvailable = 'Teña paciencia, estase a enviar o ficheiro. Os detalles sobre o envío non están disponíbeis.';
$strImportNoticePt1 = 'As estruturas seguintes foron creadas ou alteradas. Aquí pode:';
$strImportNoticePt3 = 'Mude calquera destas opcións premendo a ligazón "Opcións" correspondente';
$strGoToDatabase = 'Ir á base de datos';
$strGoToTable = 'Ir á táboa';
$strGoToView = 'Ir á vista';
$strStructureLC = 'estructure';
$strSettings = 'opcións';
...
$strTracking = 'Seguimento';
$strTrackingActivateTrackingFor = 'Activar o seguimento de %s.%s';
$strTrackingActivated = 'Activouse o seguimento de %s.%s.';
...
$strTrackingMechanism = 'Mecanismo de seguimento';
$strTrackingReport = 'Informe de seguimento';
...
$strTrackingStatements = 'Declaracións de seguimento';
...
$strTrackingVersionCreated = 'Creouse a versión %s; activouse o seguimento de %s.%s.';
$strTrackingVersionActivated = 'Activouse o seguimento de %s.%s , versión %s.';
$strTrackingVersionDeactivated = 'Desactivouse o seguimento de %s.%s , versión %s.';
$strTrackingVersionSnapshotSQL = 'Instantánea da versión %s snapshot (código SQL)';
