...
class AntSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('GrumPHP\Task\Ant');
    }

    function it_should_have_a_name()
    {
        $this->getName()->shouldBe('ant');
    }
    ...
    function it_should_have_configurable_options()
    {
        ...
        $options->getDefinedOptions()->shouldContain('build_file');
    ...
    {
        $processBuilder->createArgumentsForCommand('ant')->shouldNotBeCalled();
