...
public class GraphFactoryTest extends BaseTest {
    ...
    public void testPropertyPrefixes() {
        ...
        configuration.set("titan.hadoop.graph.output.titan.storage.backend", "cassandrathrift");
        configuration.set("titan.hadoop.graph.output.titan.ids.block-size", "100000");
        configuration.set("titan.hadoop.graph.output.titan.storage.batch-loading", "true");
        ...
        assertEquals(base.getString("titan.hadoop.graph.output.titan.storage.backend"), "cassandrathrift");
        assertEquals(base.getLong("titan.hadoop.graph.output.titan.ids.block-size"), 100000);
        assertTrue(base.getBoolean("titan.hadoop.graph.output.titan.storage.batch-loading"));
