...
/**
 * Describes the behavior of an entity responsible for sanitizing keys. Basically, it will take a
 * cache key and encrypt/decrypt to/from a string that can be safely used to create a cache entry.
 * <p/>
 * For instance, it can take a cache key like '/foo%1' and convert it to some key that can be used
 * to create a cache file's name on a file system.
 * <p/>
