...
public class BootstrapButton extends FrameLayout {
    ...
    private void initialise(AttributeSet attrs) {
        ...
        if (!isInEditMode()) {
            lblLeft.setTypeface(FontAwesomeIconMap.getFont(getContext()));
            lblRight.setTypeface(FontAwesomeIconMap.getFont(getContext()));
        }
    ...
    public void setLeftIcon(String leftIcon) {
        lblLeft.setText(FontAwesomeIconMap.getUnicode(leftIcon));
    }
    ...
    public void setRightIcon(String rightIcon) {
        lblRight.setText(FontAwesomeIconMap.getUnicode(rightIcon));
    }
