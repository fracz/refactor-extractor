...
public class FileBlockInfo implements org.apache.thrift.TBase<FileBlockInfo, FileBlockInfo._Fields>, java.io.Serializable, Cloneable, Comparable<FileBlockInfo> {
  ...
  public List<NetAddress> ufsLocations; // required
  ...
  public java.util.Iterator<NetAddress> getUfsLocationsIterator() {
  ...
  public void addToUfsLocations(NetAddress elem) {
    if (this.ufsLocations == null) {
      this.ufsLocations = new ArrayList<NetAddress>();
    }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case UFS_LOCATIONS:
      if (value == null) {
        ...
        setUfsLocations((List<NetAddress>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ufsLocations = new ArrayList<NetAddress>(_list8.size);
                NetAddress _elem9;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FileBlockInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.ufsLocations != null) {
        oprot.writeFieldBegin(UFS_LOCATIONS_FIELD_DESC);
        {
          ...
          for (NetAddress _iter11 : struct.ufsLocations)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetUfsLocations()) {
        {
          ...
          for (NetAddress _iter12 : struct.ufsLocations)
          {
            _iter12.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.ufsLocations = new ArrayList<NetAddress>(_list13.size);
          NetAddress _elem14;
