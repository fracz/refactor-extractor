...
public class CodeGenerationHelper {
     ...
     *         generated by the plugin.
     */
    public static ClassLoader generateAndCompile(String schema, String targetPackage, boolean generateBuilders) {

        File outputDirectory = generate(schema, targetPackage, generateBuilders);
