...
package im.actor.core.runtime.generic.mvvm.alg;
...
public class Modifications {
    ...
    public static <T extends ListEngineItem> im.actor.core.runtime.generic.mvvm.alg.Modification<T> addOrUpdate(final T item) {
    ...
    public static <T extends ListEngineItem> im.actor.core.runtime.generic.mvvm.alg.Modification<T> remove(final long dstId) {
    ...
    public static <T> im.actor.core.runtime.generic.mvvm.alg.Modification<T> clear() {
