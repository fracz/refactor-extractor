...
public class ASN1 {
    public static im.actor.core.runtime.crypto.asn1.ASN1Primitive readObject(byte[] sourceData) throws IOException {
        return readObject(sourceData, 0, sourceData.length);
    }

    public static im.actor.core.runtime.crypto.asn1.ASN1Primitive readObject(byte[] sourceData, int offset, int len) throws IOException {
        return readObject(new DataInput(sourceData, offset, len));
    }

    public static im.actor.core.runtime.crypto.asn1.ASN1Primitive readObject(DataInput dataInput) throws IOException {
