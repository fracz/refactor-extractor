...
import org.openhab.io.exec.ExecUtil;
...
public class ExecTransformationService implements TransformationService {
	...
	static final Logger logger = LoggerFactory
			.getLogger(ExecTransformationService.class);
	 ...
	 *
	 */
	public String transform(String commandLine, String source)
		...
		logger.debug("about to transform '{}' by the commanline '{}'", source,
				commandLine);
		...
		String result = ExecUtil.executeCommandLineAndWaitResponse(commandLine,
				5000);

		logger.trace("command line execution elapsed {} ms",
