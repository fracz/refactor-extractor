 ...
 * {@link org.elasticsearch.util.inject.PrivateModule PrivateModule} for details.
 *
...
public interface PrivateBinder extends Binder {
   ...
   * org.elasticsearch.util.inject.binder.AnnotatedElementBuilder#annotatedWith(Class) annotatedWith()} to expose {@code type} with a
   * binding annotation.
   */
