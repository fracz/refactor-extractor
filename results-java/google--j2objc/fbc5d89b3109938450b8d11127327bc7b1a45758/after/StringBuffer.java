...
public final class StringBuffer extends AbstractStringBuilder implements
    ...
    */
    ...
    public synchronized native StringBuffer append(char ch) /*-[
      AbstractStringBuilder_appendChar(self, ch);
      return self;
    ]-*/;
    ...
    public synchronized native StringBuffer append(String string) /*-[
      AbstractStringBuilder_appendString(self, string);
      return self;
    ]-*/;
    ...
    public synchronized native StringBuffer append(char[] chars, int start, int length) /*-[
      AbstractStringBuilder_appendCharArraySubset(self, chars, start, length);
      return self;
    ]-*/;
    ...
    public synchronized native StringBuffer append(CharSequence s) /*-[
      if (s == nil) {
        ...
        AbstractStringBuilder_appendCharSequence(self, s, 0, [s sequenceLength]);
      }
      return self;
    ]-*/;
    ...
    public synchronized native StringBuffer append(CharSequence s, int start, int end) /*-[
      AbstractStringBuilder_appendCharSequence(self, s, start, end);
      return self;
    ]-*/;
    ...
    public synchronized native StringBuffer deleteCharAt(int location) /*-[
      AbstractStringBuilder_deleteCharAt(self, location);
      return self;
    ]-*/;
    ...
    public synchronized native StringBuffer insert(int index, char ch) /*-[
      AbstractStringBuilder_insertChar(self, index, ch);
      return self;
    ]-*/;
    ...
    public synchronized native StringBuffer insert(int index, String string) /*-[
      AbstractStringBuilder_insertString(self, index, string);
      return self;
    ]-*/;
    ...
    public synchronized native StringBuffer insert(int index, char[] chars) /*-[
      AbstractStringBuilder_insertCharArray(self, index, chars);
      return self;
    ]-*/;
    ...
    public synchronized native StringBuffer insert(
      ...
      AbstractStringBuilder_insertCharArraySubset(self, index, chars, start, length);
      return self;
    ]-*/;
    ...
    public synchronized native StringBuffer insert(int index, CharSequence s) /*-[
      AbstractStringBuilder_insertString(self, index, s == nil ? @"null" : [s description]);
      return self;
    ]-*/;
    ...
    public synchronized native StringBuffer insert(int index, CharSequence s,
            int start, int end) /*-[
      AbstractStringBuilder_insertCharSequence(self, index, s, start, end);
      return self;
    ]-*/;
