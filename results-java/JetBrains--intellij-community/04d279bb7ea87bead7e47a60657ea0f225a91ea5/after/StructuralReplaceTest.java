...
public class StructuralReplaceTest extends IdeaTestCase {
  ...
  public void testReplace() {
    ...
    assertEquals("Basic replacement",expectedResult1,actualResult);
    ...
    String s32 = "'a = 'a;";
    String s33 = "1 = 1;";
    String expectedResult12 = "a = b; b = c;\n" +
                              "    1 = 1;\n" +
                              "    1 = 1;";
    ...
    if (IdeaTestUtil.bombExplodes(2005, Calendar.APRIL, 10, 12, 0, "lesya", "method parameter alignment")) {
      assertEquals(
