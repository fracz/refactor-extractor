...
public class CvsElementComparator implements Comparator<DefaultMutableTreeNode> {

  public static final CvsElementComparator INSTANCE = new CvsElementComparator();

  private CvsElementComparator() {}
