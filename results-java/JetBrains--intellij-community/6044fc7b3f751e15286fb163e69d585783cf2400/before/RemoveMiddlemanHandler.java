...
class RemoveMiddlemanHandler extends BaseRefactoringHandler{
    ...
    public void invoke(Project project,
        ...
        if(!(element instanceof PsiField)){
            showErrorMessage(RefactorJBundle.message("cannot.perform.the.refactoring") +
                    RefactorJBundle.message("the.caret.should.be.positioned.at.the.name.of.the.field.to.be.refactored"), project);
            return;
        }
