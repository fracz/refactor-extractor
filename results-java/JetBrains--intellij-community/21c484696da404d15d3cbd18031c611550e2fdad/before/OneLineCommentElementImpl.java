...
public class OneLineCommentElementImpl extends TypoScriptCompositeElementImpl implements OneLineCommentElement {

  public OneLineCommentElementImpl(ASTNode node) {
    super(node);
  }
