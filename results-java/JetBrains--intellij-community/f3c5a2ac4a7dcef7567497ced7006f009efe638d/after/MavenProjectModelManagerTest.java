...
public class MavenProjectModelManagerTest extends MavenImportingTestCase {
  ...
  public void testTwoRootProjects() throws Exception {
    ...
    readModel(m1, m2);
    List<MavenProjectModel> nodes = model.getRootProjects();
  ...
  public void testDoNotImportChildAsRootProject() throws Exception {
    ...
    assertEquals(1, nodes.get(0).getModules().size());
    assertEquals(m, nodes.get(0).getModules().get(0).getFile());
  }
  ...
  public void testUpdatingWholeModel() throws Exception {
    ...
    MavenProjectModel parentNode = nodes.get(0);
    MavenProjectModel childNode = nodes.get(0).getModules().get(0);
    ...
    MavenProjectModel parentNode1 = nodes.get(0);
    MavenProjectModel childNode1 = nodes.get(0).getModules().get(0);
