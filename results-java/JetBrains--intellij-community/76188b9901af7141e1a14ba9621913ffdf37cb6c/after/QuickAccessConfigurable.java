...
public class QuickAccessConfigurable extends JPanel implements SearchableConfigurable {
  ...
  public QuickAccessConfigurable(QuickAccessSettings quickAccessSettings) {
    ...
    kbConfig.setBorder(IdeBorderFactory.createTitledBorder("Keyboard Configuration", false, true));
  ...
  private void updateConflicts() {
    ...
    if (hasConflicts) {
      myConflicts.setBorder(IdeBorderFactory.createTitledBorder("Conflicts", false, true));
      c.gridx = 0;
      c.gridy++;
      c.gridwidth = 2;
