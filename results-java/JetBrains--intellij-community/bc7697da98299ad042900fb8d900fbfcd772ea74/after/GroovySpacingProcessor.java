...
public class GroovySpacingProcessor extends GroovyElementVisitor {
  ...
  public void visitOpenBlock(GrOpenBlock block) {
    ...
    if (myType1 == mLCURLY && !GroovyEditorActionUtil.isMultilineStringElement(myChild2) ||
  ...
  public void visitTypeArgumentList(GrTypeArgumentList typeArgumentList) {
    if (mLT.equals(myType1) || mGT.equals(myType2)) {
  ...
  public void visitMethod(GrMethod method) {
    ...
    else if (myType2 == mRPAREN && myType2 == THROW_CLAUSE) {
      createSpaceInCode(true);
    }
  ...
  private Spacing getSpaceBeforeLBrace(final boolean spaceBeforeLbrace, int braceStyle, @Nullable TextRange dependantRange, boolean keepOneLine) {
