...
public class SetupIsPublicVoidNoArgInspection extends MethodInspection {
    ...
    public BaseInspectionVisitor createVisitor(InspectionManager inspectionManager, boolean onTheFly) {
        return new SetupIsPublicVoidNoArgVisitor(this, inspectionManager, onTheFly);
    }

    private static class SetupIsPublicVoidNoArgVisitor extends BaseInspectionVisitor {
        private SetupIsPublicVoidNoArgVisitor(BaseInspection inspection, InspectionManager inspectionManager, boolean isOnTheFly) {
