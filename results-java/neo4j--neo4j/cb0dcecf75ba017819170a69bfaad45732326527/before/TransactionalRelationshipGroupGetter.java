...
public class TransactionalRelationshipGroupGetter implements RelationshipGroupGetter
{
    private final RecordChanges<Long, RelationshipGroupRecord, Integer> relGroupRecords;

    TransactionalRelationshipGroupGetter( RecordChanges<Long, RelationshipGroupRecord, Integer> relGroupRecords )
    {
