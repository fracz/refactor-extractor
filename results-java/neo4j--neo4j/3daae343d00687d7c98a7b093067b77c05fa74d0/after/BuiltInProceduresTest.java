...
public class BuiltInProceduresTest
{
    ...
    public void shouldListCorrectBuiltinProcedures() throws Throwable
    {
        ...
        assertThat( call( "dbms.procedures" ), containsInAnyOrder(
                ...
                record( "db.nodeManualIndexSearch",
                ...
                record( "db.nodeManualIndexSeek",
                        "db.nodeManualIndexSeek(indexName :: STRING?, key :: STRING?, value :: ANY?) :: (node :: NODE?)",
                        "Get node from manual index. Replaces `START n=node:nodes(key = 'A')`"),
                record( "db.relationshipManualIndexSearch",
                        "db.relationshipManualIndexSearch(indexName :: STRING?, query :: ANY?) :: (relationship :: RELATIONSHIP?)",
                        "Search relationship from manual index. Replaces `START r=relationship:relIndex('key:foo*')`"),
                record( "db.relationshipManualIndexSeek",
