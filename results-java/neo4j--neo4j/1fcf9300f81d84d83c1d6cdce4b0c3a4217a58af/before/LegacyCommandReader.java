...
public class LegacyCommandReader
{
            ...
            throws IOException
    {
        ...
        RelationshipCommand toReturn = new RelationshipCommand();
        toReturn.init( record );
        return toReturn;
    }
            ...
            throws IOException
    {
        ...
        NeoStoreCommand toReturn = new NeoStoreCommand();
        toReturn.init( record );
        return toReturn;
    }
    ...
    public static Command readPropertyIndexCommand( ReadableByteChannel byteChannel, ByteBuffer buffer ) throws IOException
    {
        ...
        PropertyKeyTokenCommand toReturn = new PropertyKeyTokenCommand();
        toReturn.init( record );
        return toReturn;
    }
            ...
            throws IOException
    {
        ...
        PropertyCommand toReturn = new PropertyCommand();
        toReturn.init( record, record );
        return toReturn;
    }
            ...
            throws IOException
    {
        ...
        RelationshipTypeTokenCommand toReturn = new RelationshipTypeTokenCommand();
        toReturn.init( record );
        return toReturn;
    }
