...
public class JsonWebServiceTest {
    ...
    private JsonAndHtmlWebService service;
    ...
    public void shouldRespondWith201LocationHeaderAndNodeRepresentationInJSONWhenPopulatedNodeCreatedWithArrays() throws Exception {
        Response response = service.jsonCreateNode("{\"foo\" : [\"bar\", \"baz\"] }");
    ...
    public void shouldRespondWith400WhenNodeCreatedWithInvalidJSON() throws DatabaseBlockedException {
        Response response = service.jsonCreateNode("this:::isNot::JSON}");
    ...
    public void shouldRespondWith200AndNodeRepresentationInJSONWhenNodeRequested() throws Exception {
        Response response = service.jsonGetNode(helper.createNode());
    ...
    public void shouldRespondWith404WhenRequestedNodeDoesNotExist() throws Exception {
        Response response = service.jsonGetNode(9000000000000L);
        assertEquals(404, response.getStatus());
    }

    @Test
    public void shouldRespondWith204AfterSettingPropertiesOnExistingNode() throws Exception {
        Response response = service.jsonSetNodeProperties(helper.createNode(),
    ...
    public void shouldRespondWith404WhenSettingPropertiesOnNodeThatDoesNotExist() throws Exception {
        Response response = service.jsonSetNodeProperties(9000000000000L, "{\"foo\" : \"bar\"}");
        assertEquals(404, response.getStatus());
    }

    @Test
    public void shouldRespondWith400WhenTransferringCorruptJsonPayload() throws Exception {
        Response response = service.jsonSetNodeProperties(helper.createNode(), "{\"foo\" : bad-json-here \"bar\"}");
        assertEquals(400, response.getStatus());
    }

    @Test
    public void shouldRespondWith400WhenTransferringIncompatibleJsonPayload() throws Exception {
        Response response = service.jsonSetNodeProperties(helper.createNode(), "{\"foo\" : {\"bar\" : \"baz\"}}");
        assertEquals(400, response.getStatus());
    }
    ...
    public void shouldRespondWith200ForGetNodeProperties() throws Exception {
        ...
        Response response = service.jsonGetNodeProperties(nodeId);
        assertEquals(200, response.getStatus());
        assertEquals(response.getMetadata().getFirst(HttpHeaders.CONTENT_ENCODING), "UTF-8");
    }
    ...
    public void shouldRespondWith204OnSuccessfulDelete() throws DatabaseBlockedException {
        ...
        Response response = service.jsonDeleteNode(id);
    ...
    public void shouldRespondWith404IfNodeToBeDeletedDoesNotExist() throws DatabaseBlockedException {
        ...
        Response response = service.jsonDeleteNode(nonExistentId);
    ...
    public void shouldRespondWith204ForSetNodeProperty() throws DatabaseBlockedException {
        ...
        String key = "foo";
        String json = "\"bar\"";
        Response response = service.jsonSetNodeProperty(nodeId, key, json);
        assertEquals(204, response.getStatus());
    }
    ...
    public void shouldSetRightValueForSetNodeProperty() throws DatabaseBlockedException {
        ...
        String value = "bar";
        String json = "\"" + value + "\"";
        service.jsonSetNodeProperty(nodeId, key, json);
    ...
    public void shouldRespondWith404ForSetNodePropertyOnNonExistingNode() throws DatabaseBlockedException {
        String key = "foo";
        String json = "\"bar\"";
        Response response = service.jsonSetNodeProperty(999999, key, json);
        assertEquals(404, response.getStatus());
    }
    ...
    public void shouldRespondWith201AndLocationWhenRelationshipIsCreatedWithoutProperties() throws DatabaseBlockedException {
        ...
        Response response = service.jsonCreateRelationship(startNode, "{\"to\" : \"" + BASE_URI + endNode
                + "\", \"type\" : \"LOVES\"}");
        assertEquals(201, response.getStatus());
        assertNotNull(response.getMetadata().get("Location").get(0));
    }
    ...
    public void shouldRespondWith204ForRemoveNodeProperties() throws DatabaseBlockedException {
        ...
        properties.put("number", 15);
        helper.setNodeProperties(nodeId, properties);
        Response response = service.jsonRemoveNodeProperties(nodeId);
        assertEquals(204, response.getStatus());
    }
    ...
    public void shouldBeAbleToRemoveNodeProperties() throws DatabaseBlockedException {
        ...
        properties.put("number", 15);
        helper.setNodeProperties(nodeId, properties);
        service.jsonRemoveNodeProperties(nodeId);
    ...
    public void shouldBeAbleToRemoveNodeProperty() throws DatabaseBlockedException {
        ...
        properties.put("number", 15);
        helper.setNodeProperties(nodeId, properties);
        service.jsonRemoveNodeProperty(nodeId, "foo");
    ...
    public void shouldGet404WhenRemovingNonExistingProperty() throws DatabaseBlockedException {
        ...
        properties.put("number", 15);
        helper.setNodeProperties(nodeId, properties);
        Response response = service.jsonRemoveNodeProperty(nodeId, "baz");
        assertEquals(404, response.getStatus());
    }
    ...
    public void shouldGet404WhenRemovingPropertyFromNonExistingNode() throws DatabaseBlockedException {
        long nodeId = 999999;
        Response response = service.jsonRemoveNodeProperty(nodeId, "foo");
        assertEquals(404, response.getStatus());
    }
    ...
    public void shouldGet204WhenRemovingARelationship() throws DatabaseBlockedException {
        ...
        Response response = service.jsonRemoveRelationship(relationshipId);
        assertEquals(204, response.getStatus());
    }
    ...
    public void shouldGet404WhenRemovingNonExistentRelationship() throws DatabaseBlockedException {
        ...
        Response response = service.jsonRemoveRelationship(relationshipId + 1 * 1000);
        assertEquals(404, response.getStatus());
    }
    ...
    public void shouldNotReturnDuplicatesIfSameTypeSpecifiedMoreThanOnce() throws DatabaseBlockedException {
        long nodeId = helper.createNode();
        helper.createRelationship("LIKES", nodeId, helper.createNode());
        Response response = service.jsonGetRelationships(nodeId, RelationshipDirection.all, new AmpersandSeparatedList("LIKES&LIKES"));
    ...
    public void shouldRespondWith204AndSetCorrectDataWhenSettingRelationshipProperties() throws DatabaseBlockedException {
        ...
        Response response = service.jsonSetRelationshipProperties(relationshipId, json);
        assertEquals(204, response.getStatus());
    ...
    public void shouldRespondWith204AndSetCorrectDataWhenSettingRelationshipProperty() throws DatabaseBlockedException {
        ...
        String json = "\"" + value + "\"";
        Response response = service.jsonSetRelationshipProperty(relationshipId, key, json);
        assertEquals(204, response.getStatus());
    ...
    public void shouldRespondWith400WhenSettingRelationshipPropertyWithBadJson() throws DatabaseBlockedException {
        long relationshipId = helper.createRelationship("KNOWS");
        String json = "}Mattias";
        Response response = service.jsonSetRelationshipProperty(relationshipId, "name", json);
        assertEquals(400, response.getStatus());
    }
    ...
    public void shouldRespondWith204WhenSuccessfullyRemovedRelationshipProperties() throws DatabaseBlockedException {
        ...
        Response response = service.jsonRemoveRelationshipProperties(relationshipId);
        assertEquals(204, response.getStatus());
    }
    ...
    public void shouldRespondWith404WhenNoRelationshipFromWhichToRemoveProperties() throws DatabaseBlockedException {
        ...
        Response response = service.jsonRemoveRelationshipProperties(relationshipId + 1 * 1000);
        assertEquals(404, response.getStatus());
    }
    ...
    public void shouldRespondWith204WhenRemovingRelationshipProperty() throws DatabaseBlockedException {
        ...
        Response response = service.jsonRemoveRelationshipProperty(relationshipId, "foo");
    ...
    public void shouldRespondWith404WhenNoRelationshipFromWhichToRemoveProperty() throws DatabaseBlockedException {
        ...
        Response response = service.jsonRemoveRelationshipProperty(relationshipId * 1000, "some-key");
        assertEquals(404, response.getStatus());
    }

    @Test
    public void shouldRespondWithAvailableIndexRoots() {
        Response response = service.jsonGetIndexRoot();
        assertEquals(200, response.getStatus());
    ...
    public void shouldBeAbleToIndexNode() throws DatabaseBlockedException {
        ...
        String key = "key";
        String value = "value";
        response = service.jsonAddToIndex("node", key, value, JsonHelper.createJsonFrom(nodeUri.toString()));
        assertEquals(201, response.getStatus());
    ...
    public void shouldBeAbleToGetNodeRepresentationFromIndexUri() throws DatabaseBlockedException {
        ...
        String value = "value";
        long nodeId = helper.createNode();
        Response response = service.jsonAddToIndex("node", key, value, JsonHelper.createJsonFrom(BASE_URI + "node/"
                + nodeId));
        response = service.jsonGetObjectFromIndexUri("node", key, value, nodeId);
        assertEquals(200, response.getStatus());
        assertEquals(response.getMetadata().getFirst(HttpHeaders.CONTENT_ENCODING), "UTF-8");
    ...
    public void shouldBeAbleToGetListOfNodeRepresentationsFromIndexLookup() throws DatabaseBlockedException {
        ...
        URI indexLocation1 = (URI) service.jsonAddToIndex("node", key, value, JsonHelper.createJsonFrom(location1.toString())).getMetadata().getFirst(
                "Location");
        URI indexLocation2 = (URI) service.jsonAddToIndex("node", key, value, JsonHelper.createJsonFrom(location2.toString())).getMetadata().getFirst(
                "Location");
        ...
        Response response = service.jsonGetIndexedObjects("node", key, value);
    ...
    public void shouldGet200AndEmptyListWhenNothingFoundInIndexLookup() throws DatabaseBlockedException {
        Response response = service.jsonGetIndexedObjects("node", "fooo", "baaar");
        assertEquals(Status.OK.getStatusCode(), response.getStatus());
        assertEquals(response.getMetadata().getFirst(HttpHeaders.CONTENT_ENCODING), "UTF-8");
        String entity = entityAsString(response);
    ...
    public void shouldBeAbleToRemoveNodeFromIndex() throws DatabaseBlockedException {
        ...
        Response response = service.jsonRemoveFromIndex("node", key, value, nodeId);
    ...
    public void shouldGet404IfRemovingNonExistentIndexing() throws DatabaseBlockedException {
        Response response = service.jsonRemoveFromIndex("node", "bogus", "bogus", 999999);
    ...
    public void shouldBeAbleToDescribeTraverser() throws DatabaseBlockedException {
        ...
        Response response = service.jsonTraverse(startNode, TraverserReturnType.node, description);
        assertEquals(Status.OK.getStatusCode(), response.getStatus());
        String entity = entityAsString(response);
    ...
    public void shouldBeAbleToParseJsonEvenWithUnicodeMarkerAtTheStart() throws DatabaseBlockedException {
        ...
        assertEquals(Status.NO_CONTENT.getStatusCode(), service.jsonSetNodeProperty(node, "foo", markWithUnicodeMarker("\"bar\"")).getStatus());
        assertEquals(Status.NO_CONTENT.getStatusCode(), service.jsonSetNodeProperty(node, "foo", markWithUnicodeMarker("" + 10)).getStatus());
        assertEquals(Status.NO_CONTENT.getStatusCode(), service.jsonSetNodeProperties(node, markWithUnicodeMarker("{\"name\":\"Something\",\"number\":10}"))
                .getStatus());

        assertEquals(Status.CREATED.getStatusCode(), service.jsonCreateRelationship(node,
                markWithUnicodeMarker("{\"to\":\"" + nodeLocation + "\",\"type\":\"knows\"}")).getStatus());

        long relationship = helper.createRelationship("knows");
        assertEquals(Status.NO_CONTENT.getStatusCode(), service.jsonSetRelationshipProperty(relationship, "foo", markWithUnicodeMarker("\"bar\"")).getStatus());
        assertEquals(Status.NO_CONTENT.getStatusCode(), service.jsonSetRelationshipProperty(relationship, "foo", markWithUnicodeMarker("" + 10)).getStatus());
        assertEquals(Status.NO_CONTENT.getStatusCode(), service.jsonSetRelationshipProperties(relationship,
                markWithUnicodeMarker("{\"name\":\"Something\",\"number\":10}")).getStatus());

        assertEquals(Status.CREATED.getStatusCode(), service.jsonAddToIndex("node", "foo", "bar",
                markWithUnicodeMarker(JsonHelper.createJsonFrom(nodeLocation))).getStatus());

        assertEquals(Status.OK.getStatusCode(), service.jsonTraverse(node, TraverserReturnType.node, markWithUnicodeMarker("{\"max depth\":2}")).getStatus());
    }
}