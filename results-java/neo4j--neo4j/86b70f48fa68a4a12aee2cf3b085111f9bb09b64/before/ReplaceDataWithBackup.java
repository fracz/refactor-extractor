...
public class ReplaceDataWithBackup implements MachineModifier {

    private String backupName;

    public ReplaceDataWithBackup(String backupName)
    {
    ...
    public void modify(Neo4jDriver driver, StateRegistry state)
    {
        if(driver instanceof EnterpriseDriver) {
            ((EnterpriseDriver)driver).replaceGraphDataDirWithBackup(backupName);
        }
    }
