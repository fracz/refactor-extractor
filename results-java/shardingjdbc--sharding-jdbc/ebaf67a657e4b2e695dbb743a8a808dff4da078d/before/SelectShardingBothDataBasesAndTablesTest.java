...
public final class SelectShardingBothDataBasesAndTablesTest extends AbstractShardingBothDataBasesAndTablesDBUnitTest {
    ...
    public void assertSelectLimitWithBindingTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataset("integrate/dataset/dbtbl/expect/select/SelectLimitWithBindingTable.xml", shardingDataSource.getConnection(), "t_order_item", sql, 10, 19, 1000, 1909, 2, 2);
    ...
    public void assertSelectLimitWithBindingTableWithoutOffset() throws SQLException, DatabaseUnitException {
        String sql = "SELECT i.* FROM `t_order` o JOIN `t_order_item` i ON o.user_id = i.user_id AND o.order_id = i.order_id"
                + " WHERE o.`user_id` IN (?, ?) AND o.`order_id` BETWEEN ? AND ? ORDER BY i.item_id DESC LIMIT ?";
        assertDataset("integrate/dataset/dbtbl/expect/select/SelectLimitWithBindingTableWithoutOffset.xml", shardingDataSource.getConnection(), "t_order_item", sql, 10, 19, 1000, 1909, 2);
    ...
    public void assertSelectGroupByWithBindingTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataset("integrate/dataset/dbtbl/expect/select/SelectGroupByWithBindingTable.xml", shardingDataSource.getConnection(), "t_order_item", sql, 10, 19, 1000, 1909);
    ...
    public void assertSelectNoShardingTable() throws SQLException, DatabaseUnitException {
        ...
        assertDataset("integrate/dataset/dbtbl/expect/select/SelectNoShardingTable.xml", shardingDataSource.getConnection(), "t_order_item", sql);
    }
}