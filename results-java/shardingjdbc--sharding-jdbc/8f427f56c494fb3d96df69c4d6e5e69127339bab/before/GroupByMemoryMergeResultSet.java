 ...
 * @author zhangliang
 */
public final class GroupByMemoryMergeResultSet extends AbstractMemoryMergeResultSet {
    ...
    public GroupByMemoryMergeResultSet(final Map<String, Integer> labelAndIndexMap, final List<ResultSet> resultSets,
