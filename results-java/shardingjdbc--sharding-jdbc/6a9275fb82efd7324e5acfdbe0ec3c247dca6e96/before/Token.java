...
public enum Token {
    ...
    NOCYCLE("NOCYCLE", false, false, false, true, false),
    ...
    LAST("LAST", false, false, true, false, false),
    ...
    TYPE("TYPE", false, false, true, false, true),
    ...
    AUTOMATIC("AUTOMATIC", false, false, false, true, false),
    SEQUENTIAL("SEQUENTIAL", false, false, false, true, false),
    DIMENSION("DIMENSION", false, false, false, true, false),
    MEASURES("MEASURES", false, false, false, true, false),
    SINGLE("SINGLE", false, false, false, true, false),
    RULES("RULES", false, false, false, true, false),
    ...
    IGNORE("IGNORE", false, true, false, true, false),
    NAV("NAV", false, false, false, true, false),
    FORCE("FORCE", false, true, false, false, false),
    ...
    SAMPLE("SAMPLE", false, false, false, true, false),
    BLOCK("BLOCK", false, false, false, true, false),
    SEED("SEED", false, false, false, true, false),
    VERSIONS("VERSIONS", false, false, false, true, false),
    SCN("SCN", false, false, false, true, false),
    TIMESTAMP("TIMESTAMP", false, false, false, true, false),
    SKIP("SKIP", false, false, false, true, false),
    LOCKED("LOCKED", false, false, false, true, false),
    PIVOT("PIVOT", false, false, false, true, false),
    UNPIVOT("UNPIVOT", false, false, false, true, false),
    INCLUDE("INCLUDE", false, false, false, true, false),
    EXCLUDE("EXCLUDE", false, false, false, true, false),
    XML("XML", false, false, false, true, true),
    BROWSE("BROWSE", false, false, false, false, true),
    AUTO("AUTO", false, false, false, false, true),
    XMLSCHEMA("XMLSCHEMA", false, false, false, false, true),
    ELEMENTS("ELEMENTS", false, false, false, false, true),
    XSINIL("XSINIL", false, false, false, false, true),
