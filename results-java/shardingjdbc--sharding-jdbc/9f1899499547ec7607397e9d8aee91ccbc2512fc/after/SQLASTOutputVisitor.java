...
public class SQLASTOutputVisitor extends SQLASTVisitorAdapter implements PrintableVisitor {
    ...
    public boolean visit(SQLColumnDefinition x) {
        ...
        for (SQLColumnConstraint item : x.getConstraints()) {
            boolean newLine = item instanceof SQLForeignKeyConstraint || item instanceof SQLPrimaryKey || item instanceof SQLColumnCheck || item.getName() != null;
            if (newLine) {
                incrementIndent();
                println();
            } else {
        ...
        if (null != x.getEnable() && x.getEnable()) {
            print(" ENABLE");
        }
