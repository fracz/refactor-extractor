...
public class OracleCreateIndexTest7 extends OracleTest {
    ...
    public void test_0() throws Exception {
        ...
        assertEquals("CREATE INDEX ord_customer_ix_demo ON orders(customer_id, sales_rep_id)\n" +
                "COMPRESS 1;", SQLUtils.toSQLString(stmt, JdbcConstants.ORACLE));
