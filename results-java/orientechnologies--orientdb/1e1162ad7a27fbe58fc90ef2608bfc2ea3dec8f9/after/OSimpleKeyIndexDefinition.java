...
public class OSimpleKeyIndexDefinition extends ODocumentWrapperNoClass implements OIndexDefinition {
    ...
    public Comparable createValue(final List<?> params) {
        ...
        for (final Object param : params) {
            final Comparable paramValue =
                    (Comparable) OType.convert(param, keyTypes[i].getDefaultJavaType());
    ...
    public boolean equals(final Object o) {
        ...
        if (!Arrays.equals(keyTypes, that.keyTypes)) return false;
    ...
    public String toString() {
        return "OSimpleKeyIndexDefinition{" +
                "keyTypes=" + (keyTypes == null ? null : Arrays.asList(keyTypes)) +
                '}';
    }
