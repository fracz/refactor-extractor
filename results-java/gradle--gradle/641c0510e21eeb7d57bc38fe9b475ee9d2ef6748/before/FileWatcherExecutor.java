...
class FileWatcherExecutor implements Runnable {
    ...
    public FileWatcherExecutor(AtomicBoolean runningFlag, Runnable callback, Collection<DirectoryTree> directoryTrees, Collection<File> files, CountDownLatch waitUntilWatching) {
