...
public class PluginUnderTestMetadata extends DefaultTask {
    ...
    public void generate() {
        ...
        if (!getPluginClasspath().isEmpty()) {
            ...
            DefaultClasspathHasher classPathSnapshotter = new DefaultClasspathHasher(getClasspathSnapshotter());
            String hash = classPathSnapshotter.hash(new DefaultClassPath(getPluginClasspath())).toString();
    ...
    @Inject
    protected ClasspathSnapshotter getClasspathSnapshotter() {
