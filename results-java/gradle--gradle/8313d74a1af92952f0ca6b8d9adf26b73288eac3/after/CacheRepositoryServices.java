...
public class CacheRepositoryServices {
    ...
    protected CacheKeyBuilder createCacheKeyBuilder(FileHasher fileHasher, ClasspathHasher hasher) {
        return new DefaultCacheKeyBuilder(Hashing.md5(), fileHasher, hasher);
    }
}