...
public class NativeTestSuitesRules extends RuleSource {

    public static <T extends NativeTestSuiteSpec> void apply(ModelRegistry registry, Class<T> testSuiteClass) {
