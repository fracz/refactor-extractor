...
public class DBeaverPreferencesInitializer extends AbstractPreferenceInitializer {
  ...
  public void initializeDefaultPreferences() {
      ...
      RuntimeUtils.setDefaultPreferenceValue(store, DBeaverPreferences.UI_DRIVERS_SOURCES, "http://dbeaver.jkiss.org/files/jdbc/");
      ...
      RuntimeUtils.setDefaultPreferenceValue(store, DBeaverPreferences.RESULT_SET_BINARY_EDITOR_TYPE, IValueController.EditType.EDITOR);
