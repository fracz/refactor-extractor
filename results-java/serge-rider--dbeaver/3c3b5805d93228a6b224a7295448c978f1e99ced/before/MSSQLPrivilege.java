 ...
 * MSSQLPrivilege
 */
public class MSSQLPrivilege implements DBAPrivilege
{
    static final Log log = LogFactory.getLog(MSSQLPrivilege.class);
    ...
    public MSSQLPrivilege(MSSQLDataSource dataSource, ResultSet resultSet) {
